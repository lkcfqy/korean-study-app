...
<h2>180 天如何安排</h2>
<p>两个月一组，按词典目标词的初、中、高级顺序安排；这不是国语院对整段对话的等级认证。首周每天新增词条不超过 28 个，之后不超过 60 个。学习日同时安排隔天、一周、一个月的回忆复习，每天合计 240 分钟；最后一个月内容的一月后复习需要延续到第 210 天。全部关卡随时可选。</p>
<h2>固定 SunHi 读音</h2>
<p>句子、词条和拼读示例使用 {len(audio['entries']):,} 段固定的 ko-KR-SunHiNeural 合成音频，正常语速生成；慢速播放保留音高。句子整段合成，保留连读和语调，不拼接单词音频。</p>
<p>发布前验证音频引用并进行解码、静音和削波检查。此前发布的完整句子还经过不提供原文提示的自动转写复核，低匹配项单独复核。本轮按文件哈希确认旧音频未变，并检查新生成的音频；新增音频包括修正后的原形、独立词块和一条更正拼写的句子，不包含在此前的整句转写报告内。自动转写与信号检查不能代替母语者逐条听审，本次未完成全部音频的人工听审。</p>
<h2>署名与许可</h2>
