...
const lineSchema=z.object({id:z.string(),ko:z.string(),zh:z.string(),note:z.string(),words:z.array(wordSchema),parts:z.array(z.object({text:z.string(),meaning:z.string(),explanation:z.string()})).min(1),audio:z.string(),speakerIndex:z.number().int().min(0).max(1)});
