...
export default function StudyPlan({initialMonth,disabled,onChooseLesson}:{initialMonth:number;disabled:boolean;onChooseLesson:(id:string)=>void}){
 ...
 return <>
  ...
  <div className="plan-note"><strong>目标需要用测评验证</strong><p>半年从零冲刺 TOPIK 6 是高强度目标，学习时长和词句数量不能保证结果。TOPIK II 纸笔考试 6 级线为 230/300；机考为 431/600，训练时请使用相应尺度。本日程的模考按纸笔格式安排。</p><p>每句配有中文、点词注释和固定 SunHi 音频。具体审校方式与覆盖见来源说明；自动复核不等于独立教师逐条认证。</p></div>
 </>;
}
